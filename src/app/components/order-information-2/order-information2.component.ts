...
@Component({
    ...
    templateUrl: './order-information2.component.html',
    styleUrls: ['./order-information2.component.css']
})
export class OrderInformation2Component implements OnInit, AfterViewInit {
    ...
    changePage(eventPage, eventSort): void {
